...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp
                                                      # x (%rdi) == input (a pointer)
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi # y = $0x402400
  400ee9:	e8 4a 04 00 00       	call   401338 <strings_not_equal> # return 1 when not equal!
  400eee:	85 c0                	test   %eax,%eax # test eax == 0?
  400ef0:	74 05                	je     400ef7 <phase_1+0x17> # if eax == 0 then jump, that is - defuse!
...
0000000000400efc <phase_2>:
  ...
  400efe:	48 83 ec 28          	sub    $0x28,%rsp
                                                # pass x = input address (%rdi)
  400f02:	48 89 e6             	mov    %rsp,%rsi # pass y = %rsp?
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers> # read 6 number from user input!
                                        # read to where (somewhere in the stack!)
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) # 1st == 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34> # jump to a loop1 or Boom!
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  # TODO LOOP 2
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    %eax,%eax
  400f1c:	39 03                	cmp    %eax,(%rbx) # 2nd == 2
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
  400f29:	48 39 eb             	cmp    %rbp,%rbx # boundary checking!
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> # defuse
  # TODO LOOP1
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b> # jump up to loop 2
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # put 2nd here - [rsp + 12]
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # put 1st here - [rsp + 8]
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi # "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
                                      # read 2 numbers
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> # read < 2 -> BOOM!
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # 1st should (0, 8) else BOOM!
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) # what?
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax # 1st == 0, jump here
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b> # jump to loop 2
  ...
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax # 1st == 1
  # TODO LOOP2
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax
  400fc2:	74 05                	je     400fc9 <phase_3+0x86> # eax == [rsp + 12] then DEFUSE
...
0000000000400fce <func4>:
  ...
  400fdb:	01 c8                	add    %ecx,%eax
                                        ...
                                        # what is the usage previous command??
  400fdd:	d1 f8                	sar    $1,%eax # eax = 7
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # ecx = 7
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # if 7 - edi <= 0, to LOOP1
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx # why compare again?
  400ff9:	7d 0c                	jge    401007 <func4+0x39> # LOOP2 - defuse!
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # put 2nd here - [rsp + 12]
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # put 1st here - [rsp + 8]
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi # read 2 number
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29> # read != 2, BOOM!
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # 1st should be [0, 14]
  401033:	76 05                	jbe    40103a <phase_4+0x2e> # if above, BOOM
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  # TODO where it begins
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi 
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi
  401048:	e8 81 ff ff ff       	call   400fce <func4> # func4([rsp + 8], 0, 14)
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c> # func() should be 0 
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51> # [rsp + 12] should be 0!
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx # rbx == input addr
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax # read something to %rax, one very big number!
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax # set eax = 0
  40107a:	e8 9c 02 00 00       	call   40131b <string_length> # s_l(input)
  40107f:	83 f8 06             	cmp    $0x6,%eax
  401082:	74 4e                	je     4010d2 <phase_5+0x70> # len should be 6
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  # TODO LOOP2
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx # first rax == 0
  40108f:	88 0c 24             	mov    %cl,(%rsp) # store - why store original?
  401092:	48 8b 14 24          	mov    (%rsp),%rdx # rdx = 0th char
  401096:	83 e2 0f             	and    $0xf,%edx # cut upper half, remain lowest hex
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx # update rdx using rdx?
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) # store chars at stack
  4010a4:	48 83 c0 01          	add    $0x1,%rax
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax
  4010ac:	75 dd                	jne    40108b <phase_5+0x29> # loop2; update rax
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi # flyers
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal>
  4010c2:	85 c0                	test   %eax,%eax
  4010c4:	74 13                	je     4010d9 <phase_5+0x77> # not equal -> BOOM
  ...
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c> # defuse
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers> # r_s_n(input, rsp)
  # TODO entry
  40110b:	49 89 e6             	mov    %rsp,%r14 # why store rsp again?
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d # why? set 0
  # TODO LOOP2
  401114:	4c 89 ed             	mov    %r13,%rbp # why store rsp elsewhere
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # eax = [rsp], first char
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34> # eax should be <= 5 - [0, 5]
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d # a loop test
  401130:	74 21                	je     401153 <phase_6+0x5f> # if exit, to END2
# if r12 == 6, then go down normally
  401132:	44 89 e3             	mov    %r12d,%ebx # ebx == 6
      # TODO LOOP1
      401135:	48 63 c3             	movslq %ebx,%rax # rax == 6
                                            # each number read from input is store at interval of 4B
      401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax 
      40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # what is in rbp
                                          # eax should be != [rbp]
      40113e:	75 05                	jne    401145 <phase_6+0x51>
      401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
      401145:	83 c3 01             	add    $0x1,%ebx
      401148:	83 fb 05             	cmp    $0x5,%ebx
      40114b:	7e e8                	jle    401135 <phase_6+0x41> # go LOOP1 when ebx <= 5
      40114d:	49 83 c5 04          	add    $0x4,%r13
      # TODO END1
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # jump to LOOP2
  # TODO END2
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi # rsi = rsp + 24 (boundary)
  401158:	4c 89 f0             	mov    %r14,%rax # rax = rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  # TODO LOOP3
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx # edx = 7 - (each num)
  401164:	89 10                	mov    %edx,(%rax) # store back at rax!
  401166:	48 83 c0 04          	add    $0x4,%rax # move to next num
  ...
  # TODO LOOP1 (else)
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx # TODO keep derefenceing?
  40117a:	83 c0 01             	add    $0x1,%eax
  40117d:	39 c8                	cmp    %ecx,%eax # if eax != number, jump LOOP1
  40117f:	75 f5                	jne    401176 <phase_6+0x82> # LOOP until eax == number
  401181:	eb 05                	jmp    401188 <phase_6+0x94> # find eax == number
  # TODO wayout (when number == 1)
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx # some addr? like below
  # TODO after find eax == number
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # write to rsp+32!
  40118d:	48 83 c6 04          	add    $0x4,%rsi # process next number!
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7> # goto END
  # TODO LOOP2
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx # at this point, the number should be within 1B
  40119a:	83 f9 01             	cmp    $0x1,%ecx # jump when ecx <= 1
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # this might be a way out
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> # jump to else logic
  # TODO END, to next part
  ...
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) 
                                      # append curr node to prev node
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax # LOOP test
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> # END
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> # LOOP3
  # TODO END3
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) # rdx = last node (might not be node 6)
                                                      # this is to set NULL at the end of list
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax
  4011e3:	8b 00                	mov    (%rax),%eax # only lower half!
  4011e5:	39 03                	cmp    %eax,(%rbx) # jump when (rbx) >= eax, or BOOM
...
000000000040131b <string_length>:
  # only uses %rdi because this is the use input!
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi) # this is the user input!
...
0000000000401338 <strings_not_equal>:
  # save callee saved reg first!
  401338:	41 54                	push   %r12
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx

  # save these 2 args
  40133c:	48 89 fb             	mov    %rdi,%rbx # %rdi == user input!
  40133f:	48 89 f5             	mov    %rsi,%rbp # %rsi == $0x402400

  401342:	e8 d4 ff ff ff       	call   40131b <string_length> # compute the length of input
  401347:	41 89 c4             	mov    %eax,%r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length> # compute the length of target str
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d
                                        # not equal, goto return with %edx == 1
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63> 
  40135c:	0f b6 03             	movzbl (%rbx),%eax # %rbx == user input address
  40135f:	84 c0                	test   %al,%al # TODO check if 0? the start of user input should be 0x0???
                                                # very weird, correct answer does not follow this path!
                                                # or this is unnecessary checking! 
                                                # originally used as condition checking for while statement in the front
  401361:	74 25                	je     401388 <strings_not_equal+0x50> # defuse!
  ...
  40139b:	89 d0                	mov    %edx,%eax # start to return!
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
00000000004013a2 <initialize_bomb>:
  ...
  4013a6:	be a0 12 40 00       	mov    $0x4012a0,%esi # esi = a number?
  4013ab:	bf 02 00 00 00       	mov    $0x2,%edi # edi = a number?
  4013b0:	e8 db f7 ff ff       	call   400b90 <signal@plt> # call a void function
...
# TODO read 6 number from user input as local variables in phase_2() so as to compare!
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp
  401460:	48 89 f2             	mov    %rsi,%rdx # 3th arg?
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # 4th?
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax # why?
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) # 6th arg
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp) # 5th arg
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi # "%d %d ..." 6 times
  401485:	b8 00 00 00 00       	mov    $0x0,%eax
  40148a:	e8 61 f7 ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  40148f:	83 f8 05             	cmp    $0x5,%eax # if read more than 5 (6 or more)
